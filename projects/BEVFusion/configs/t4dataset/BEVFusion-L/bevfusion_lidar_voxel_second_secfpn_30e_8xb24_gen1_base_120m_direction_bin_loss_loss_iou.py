...
experiment_name = "lidar_voxel_second_secfpn_30e_8xb24_gen1_base_120m_direction_bin_loss_loss_iou"
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_orientation=dict(_delete_=True, type="mmdet.SmoothL1Loss", reduction="mean", loss_weight=0.25, beta=0.05),
        loss_direction=dict(
            _delete_=True,
