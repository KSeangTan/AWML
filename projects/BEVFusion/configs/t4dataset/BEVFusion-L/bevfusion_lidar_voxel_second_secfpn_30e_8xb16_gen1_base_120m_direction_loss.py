...
experiment_name = "lidar_voxel_second_secfpn_30e_8xb16_gen1_base_120m_direction_loss"
...
model = dict(
    ...
    bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            direction_sigmoid_threshold=0.5
        ),
        ...
        loss_direction_ignore_labels=["barrier"]
        loss_orientation=dict(_delete_=True, type="mmdet.SmoothL1Loss", reduction="mean", loss_weight=0.25, beta=0.15),
